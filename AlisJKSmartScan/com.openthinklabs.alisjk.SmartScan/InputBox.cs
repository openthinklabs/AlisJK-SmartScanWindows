...
namespace com.openthinklabs.alisjk.SmartScan
{
	...
	public class InputBox
	{
        ...
        public static DialogResult ShowEssai(string title, string promptText, ref string value)
        {
            return Show(title, promptText, ref value, null);
        }

        public static DialogResult ShowEssai(string title, string promptText, ref string value, InputBoxValidation validation)
        {
            Form form = new Form();
